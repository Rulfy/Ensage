...
namespace Ensage.Common
{
    ...
    public static class Render
    {
        ...
        public class Sprite : RenderObject
        {
            ...
            //{
            //    UpdateTextureBitmap(
            //        (Bitmap) MediaTypeNames.Image.FromStream(BaseTexture.ToStream(texture, ImageFileFormat.Bmp)), position);
            //}
            ...
            //{
            //    UpdateTextureBitmap((Bitmap) MediaTypeNames.Image.FromStream(new MemoryStream(bytesArray)), position);
            //}
            ...
            //{
            //    UpdateTextureBitmap(
            //        (Bitmap) MediaTypeNames.Image.FromStream(BaseTexture.ToStream(_originalTexture, ImageFileFormat.Bmp)));
            ...
            //private static Bitmap SaturateBitmap(MediaTypeNames.Image original, float saturation)
            //{
